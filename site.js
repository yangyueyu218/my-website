...
document.addEventListener('click',e=>{const manage=e.target.closest('[data-manage-open]'),close=e.target.closest('[data-close-dialog]');if(close){close.closest('dialog').close();return;}if(manage){closeMenus();dialogOpener=manage;$('#manage-dialog').showModal();}});
